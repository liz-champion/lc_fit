...
GW170817:
	...
	python3 ${LC_FIT_LOCATION}/bin/dag_setup.py --working-dir ${LC_FIT_LOCATION}/pe_runs/$@_${DATE}/ --evaluate-interpolator-exe ${LC_FIT_LOCATION}/bin/evaluate_interpolator.py --lc-file pe_runs/$@_${DATE}/lc_data.json --bands g r i z y J H K --n-iterations 1
